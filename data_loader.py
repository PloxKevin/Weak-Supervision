...
#take 2 directory as argument
#is input img, can be train/test
# train val test
    def __init__(self, mnist_dir):
        self.examples = np.loadtxt("datasets/split/60.csv", delimiter=",")
...
#    def __init__(self):
#        self.examples = np.loadtxt("datasets/mnist_combined.csv", delimiter=",")[5000:]
